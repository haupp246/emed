...
class HospitalsControllerTest < ActionController::TestCase
  ...
  test "should create hospital" do
    assert_difference('Hospital.count') do
      post :create, hospital: { address: @hospital.address, code: @hospital.code, email: @hospital.email, fax: @hospital.fax, name: @hospital.name, phone: @hospital.phone, website: @hospital.website }
    end
  ...
  test "should update hospital" do
    patch :update, id: @hospital, hospital: { address: @hospital.address, code: @hospital.code, email: @hospital.email, fax: @hospital.fax, name: @hospital.name, phone: @hospital.phone, website: @hospital.website }
    assert_redirected_to hospital_path(assigns(:hospital))
  end
